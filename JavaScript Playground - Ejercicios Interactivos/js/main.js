...
class Ejercicios{
    ...
    Ejercicio45() {
        ...
        if (isNaN(n1) || n1 < 1 || n1 > 100) {
            document.getElementById("Respuesta45").innerHTML = "⚠️ Por favor ingresa un número entre 1 y 100";
            return;
        }
        ...
        if (n1 === this.secretNumber) {
            document.getElementById("Respuesta45").innerHTML = `🎉 ¡FELICIDADES! ¡Adivinaste el número ${this.secretNumber}!<br>Lo lograste en ${10 - this.attempts} intentos`;
            document.getElementById("hintBox").style.display = "none";
            this.secretNumber = null; // Resetear para nuevo juego
        } else if (this.attempts === 0) {
            document.getElementById("Respuesta45").innerHTML = `😔 ¡Se acabaron los intentos! El número era ${this.secretNumber}`;
            document.getElementById("hintBox").innerHTML = "Presiona 'Nuevo Juego' para intentar de nuevo";
            document.getElementById("hintBox").style.display = "block";
            this.secretNumber = null;
        } else {
            let hint = "";
            let difference = Math.abs(n1 - this.secretNumber);
            ...
            if (difference <= 5) {
                ...
                hint = "🤔 Estás algo lejos";
            } else {
                hint = "🌍 Estás muy lejos";
            }

            if (n1 < this.secretNumber) {
                document.getElementById("Respuesta45").innerHTML = `📈 El número es MAYOR que ${n1}`;
                document.getElementById("hintBox").innerHTML = hint;
            } else {
                document.getElementById("Respuesta45").innerHTML = `📉 El número es MENOR que ${n1}`;
                document.getElementById("hintBox").innerHTML = hint;
            }
            document.getElementById("hintBox").style.display = "block";
        }
